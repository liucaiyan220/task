...
from sklearn.model_selection import train_test_split #调入scikit-learn库中交叉检验，划分训练集和测试集
...
# 使用决策树算法进行训练
from sklearn.tree import DecisionTreeClassifier #调入scikit-learn库中的DecisionTreeClassifier来构建决策树
# 定义一个决策树对象
